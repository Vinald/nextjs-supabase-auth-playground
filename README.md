...
See [`AUTH_SETUP.md`](./AUTH_SETUP.md) for what each flow needs and a
checklist for porting this into another app. The deeper runbook —
step-by-step setup plus a troubleshooting table of every error hit while
building this — lives in
[`.claude/skills/supabase-auth-setup/`](./.claude/skills/supabase-auth-setup/SKILL.md),
a [Claude Code](https://claude.com/claude-code) skill that reproduces this
setup (and debugs the same failure modes) in other projects.
